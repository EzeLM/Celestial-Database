...
--
-- Name: types pk_types; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--
...
--
-- Name: types unq_type_id; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.types
    ADD CONSTRAINT unq_type_id UNIQUE (type_id);
